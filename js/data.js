// Team -> ISO 3166 code used by flagcdn.com (England/Scotland use GB subdivisions).
// Rendered as <img> so flags show on every OS — Windows has no flag emoji glyphs.
export const FLAGS = {
...
export const KNOCKOUT = {
  ...
  // Bracket pairings follow the official 2026 knockout flow (FIFA / Wikipedia),
  // matched slot-by-slot via the R32 feeders — not a naive consecutive pairing.
  r16: [
    { id: 'R16_01', home: {type:'mw',id:'R32_01'}, away: {type:'mw',id:'R32_03'} },
    { id: 'R16_02', home: {type:'mw',id:'R32_02'}, away: {type:'mw',id:'R32_05'} },
    { id: 'R16_03', home: {type:'mw',id:'R32_04'}, away: {type:'mw',id:'R32_06'} },
    { id: 'R16_04', home: {type:'mw',id:'R32_07'}, away: {type:'mw',id:'R32_08'} },
    { id: 'R16_05', home: {type:'mw',id:'R32_11'}, away: {type:'mw',id:'R32_12'} },
    { id: 'R16_06', home: {type:'mw',id:'R32_09'}, away: {type:'mw',id:'R32_10'} },
    { id: 'R16_07', home: {type:'mw',id:'R32_14'}, away: {type:'mw',id:'R32_16'} },
    { id: 'R16_08', home: {type:'mw',id:'R32_13'}, away: {type:'mw',id:'R32_15'} },
  ],
  qf: [
    { id: 'QF_01', home: {type:'mw',id:'R16_01'}, away: {type:'mw',id:'R16_02'} },
    { id: 'QF_02', home: {type:'mw',id:'R16_05'}, away: {type:'mw',id:'R16_06'} },
    { id: 'QF_03', home: {type:'mw',id:'R16_03'}, away: {type:'mw',id:'R16_04'} },
...
// World Cup honours per nation — STATIC historical data (the API doesn't expose it).
// `played` counts final-tournament appearances including 2026; `won` = titles;
// `best` = best historical result; `since` = year of first appearance.
// Heritage note: Germany includes West Germany; appearance counts are best-effort and
// worth a sanity check before each edition.
export const HONOURS = {
  'México': { played: 18, won: 0, best: 'Quartas de final', since: 1930 },
  'África do Sul': { played: 4, won: 0, best: 'Fase de grupos', since: 1998 },
  'Coreia do Sul': { played: 12, won: 0, best: '4º lugar', since: 1954 },
  'República Tcheca': { played: 10, won: 0, best: 'Vice-campeão', since: 1934, note: 'Inclui a era Tchecoslováquia (vice-campeã em 1934 e 1962). Como República Tcheca: 2 Copas desde 2006.' },
  'Canadá': { played: 3, won: 0, best: 'Fase de grupos', since: 1986 },
  'Bósnia e Herzegovina': { played: 2, won: 0, best: 'Fase de grupos', since: 2014 },
  'Catar': { played: 2, won: 0, best: 'Fase de grupos', since: 2022 },
  'Suíça': { played: 13, won: 0, best: 'Quartas de final', since: 1934 },
  'Brasil': { played: 23, won: 5, best: 'Campeão', since: 1930 },
  'Marrocos': { played: 7, won: 0, best: '4º lugar', since: 1970 },
  'Haiti': { played: 2, won: 0, best: 'Fase de grupos', since: 1974 },
  'Escócia': { played: 9, won: 0, best: 'Fase de grupos', since: 1954 },
  'Estados Unidos': { played: 12, won: 0, best: '3º lugar', since: 1930 },
  'Paraguai': { played: 9, won: 0, best: 'Quartas de final', since: 1930 },
  'Austrália': { played: 7, won: 0, best: 'Oitavas de final', since: 1974 },
  'Turquia': { played: 3, won: 0, best: '3º lugar', since: 1954 },
  'Alemanha': { played: 21, won: 4, best: 'Campeão', since: 1934 },
  'Curaçao': { played: 1, won: 0, best: 'Estreante', since: 2026 },
  'Costa do Marfim': { played: 4, won: 0, best: 'Fase de grupos', since: 2006 },
  'Equador': { played: 5, won: 0, best: 'Oitavas de final', since: 2002 },
  'Holanda': { played: 12, won: 0, best: 'Vice-campeão', since: 1934 },
  'Japão': { played: 8, won: 0, best: 'Oitavas de final', since: 1998 },
  'Suécia': { played: 13, won: 0, best: 'Vice-campeão', since: 1934 },
  'Tunísia': { played: 7, won: 0, best: 'Fase de grupos', since: 1978 },
  'Bélgica': { played: 15, won: 0, best: '3º lugar', since: 1930 },
  'Egito': { played: 4, won: 0, best: 'Oitavas de final', since: 1934 },
  'Irã': { played: 7, won: 0, best: 'Fase de grupos', since: 1978 },
  'Nova Zelândia': { played: 3, won: 0, best: 'Fase de grupos', since: 1982 },
  'Espanha': { played: 17, won: 1, best: 'Campeão', since: 1934 },
  'Cabo Verde': { played: 1, won: 0, best: 'Estreante', since: 2026 },
  'Arábia Saudita': { played: 7, won: 0, best: 'Oitavas de final', since: 1994 },
  'Uruguai': { played: 15, won: 2, best: 'Campeão', since: 1930 },
  'França': { played: 17, won: 2, best: 'Campeão', since: 1930 },
  'Senegal': { played: 4, won: 0, best: 'Quartas de final', since: 2002 },
  'Iraque': { played: 2, won: 0, best: 'Fase de grupos', since: 1986 },
  'Noruega': { played: 4, won: 0, best: 'Oitavas de final', since: 1938 },
  'Argentina': { played: 19, won: 3, best: 'Campeão', since: 1930 },
  'Argélia': { played: 5, won: 0, best: 'Oitavas de final', since: 1982 },
  'Áustria': { played: 8, won: 0, best: '3º lugar', since: 1934 },
  'Jordânia': { played: 1, won: 0, best: 'Estreante', since: 2026 },
  'Portugal': { played: 9, won: 0, best: '3º lugar', since: 1966 },
  'Congo (RD)': { played: 2, won: 0, best: 'Fase de grupos', since: 1974 },
  'Uzbequistão': { played: 1, won: 0, best: 'Estreante', since: 2026 },
  'Colômbia': { played: 7, won: 0, best: 'Quartas de final', since: 1962 },
  'Inglaterra': { played: 17, won: 1, best: 'Campeão', since: 1950 },
  'Croácia': { played: 7, won: 0, best: 'Vice-campeão', since: 1998 },
  'Gana': { played: 5, won: 0, best: 'Quartas de final', since: 2006 },
  'Panamá': { played: 2, won: 0, best: 'Fase de grupos', since: 2018 },
};
