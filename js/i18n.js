...
const DICT = {
  pt: {
    ...
    'ko.viewBracket': 'Meu chaveamento',
    'ko.viewOfficial': 'Oficial',
    'ko.fillTitle': 'Preencha o que faltou',
    'ko.fillSub': 'O chaveamento real saiu. Palpite os confrontos que você errou — valem <strong>2 / 1</strong>.',
    'ko.gapsLabel': 'Pra preencher',
    'ko.cravadosLabel': 'Você cravou',
    'ko.cravadoBadge': 'Cravou o confronto · 5 / 3',
    'ko.liveBadge': 'Palpite ao vivo · 2 / 1',
    'ko.youPredicted': 'Você previu: {matchup}',
    'ko.swap': 'Trocar placar',
    'ko.swapWarn': 'Ao trocar, este palpite passa a valer no máximo 2 / 1.',
    'ko.swapCancel': 'Manter o cravado',
    'ko.officialEmpty': 'O chaveamento oficial aparece aqui quando a fase de grupos terminar.',
    'ko.allDone': 'Tudo preenchido por aqui! 🎉 Novos confrontos aparecem a cada rodada.',
    'ko.later': 'Ver depois',
    ...
    'fx.fillOfficial': 'Você errou esse confronto — palpite o real em Mata-Mata › Oficial (vale 2/1)',
  ...
  en: {
    ...
    'ko.viewBracket': 'My bracket',
    'ko.viewOfficial': 'Official',
    'ko.fillTitle': 'Fill in what you missed',
    'ko.fillSub': 'The real bracket is out. Predict the matchups you got wrong — they\'re worth <strong>2 / 1</strong>.',
    'ko.gapsLabel': 'To fill in',
    'ko.cravadosLabel': 'You nailed',
    'ko.cravadoBadge': 'Matchup nailed · 5 / 3',
    'ko.liveBadge': 'Live pick · 2 / 1',
    'ko.youPredicted': 'You predicted: {matchup}',
    'ko.swap': 'Change score',
    'ko.swapWarn': 'Changing it caps this pick at 2 / 1.',
    'ko.swapCancel': 'Keep the nailed pick',
    'ko.officialEmpty': 'The official bracket shows up here once the group stage ends.',
    'ko.allDone': 'All filled in here! 🎉 New matchups appear each round.',
    'ko.later': 'See later',
    ...
    'fx.fillOfficial': 'You missed this matchup — pick the real one on Knockout › Official (worth 2/1)',
