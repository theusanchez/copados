...
export const deletePreds = (...a) => backend.deletePreds(...a);
export const getResetVersion = (...a) => backend.getResetVersion(...a);
export const setResetVersion = (...a) => backend.setResetVersion(...a);
